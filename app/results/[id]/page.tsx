...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen flex justify-center px-4 py-12 overflow-y-auto">
        ...
        >
          <Card>
            ...
            <CardContent className="space-y-6">
                ...
                {isImageResult(result) && (
                  <>
                    <ResultDetailItem
                      ...
                      value={
                        result.detectedElements.isUpiInterface ? "Yes" : "No"
                      }
                    />
              ...
              {(isImageResult(result) &&
                result.analysisDetails.warnings?.length) ||
              ...
              (isUpiResult(result) && result.details.warnings?.length) ? (
                <div className="bg-destructive/10 p-4 rounded-md">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    {isImageResult(result) &&
                      result.analysisDetails.warnings?.map((warning, index) => (
              ...
              {(isImageResult(result) &&
                result.analysisDetails.recommendations?.length) ||
              ...
              (isUpiResult(result) && result.details.recommendations?.length) ? (
                <div className="bg-primary/10 p-4 rounded-md">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    {isImageResult(result) &&
                      result.analysisDetails.recommendations?.map(
                        (rec, index) => (
                          <li key={index} className="text-sm">
                            {rec}
                          </li>
