...
const formSchema = z.object({
  upiId: z
    ...
    .regex(
      UPI_ID_PATTERN,
      "Invalid UPI ID format. It should be in the format username@provider"
    ),
});
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Verify the legitimacy of UPI payment addresses before sending
                money.
              </CardDescription>
            </CardHeader>
            <Form {...form}>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-muted p-4 rounded-md text-sm">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li>
                        A valid UPI ID should be in the format username@provider
                      </li>
                      <li>
                        Be cautious of UPI IDs containing words like "refund",
                        "help", or "support"
                      </li>
                      <li>
                        Verify the UPI ID matches the person or business you
                        intend to pay
                      </li>
                      <li>
                        Official bank UPI handles include okaxis, oksbi,
                        okicici, okhdfcbank, etc.
                      </li>
                    </ul>
                  </div>
                </CardContent>
