        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Scan and analyze QR codes to detect potentially malicious
                payment requests.
              </CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit(onSubmit)}>
              <CardContent className="space-y-6">
                ...
                {previewUrl && <ImageUploadPreview url={previewUrl} />}
                ...
                <div className="bg-muted p-4 rounded-md text-sm">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                    <li>
                      Always verify the merchant before scanning a QR code
                    </li>
                    <li>
                      Be cautious of QR codes in unexpected places or from
                      unknown sources
                    </li>
                    <li>
                      Check the URL or UPI ID the QR code redirects to before
                      proceeding
                    </li>
                    <li>
                      Be wary of QR codes promising rewards, cashbacks, or
                      urgent action
                    </li>
                  </ul>
                </div>
